...
import { getSortedEntrantsBySpecBudget_2 } from "../../../../redux/api/entrant";
...
function SpecByBudget2(props) {
  ...
  React.useEffect(() => {
    const fetchEntrants = async () => {
      return await dispatch(getSortedEntrantsBySpecBudget_2());
    };
        ...
        <Row>
          <Col>
            <h3 style={{ textAlign: "center", marginBottom: "30px" }}>
              Список абитуриентов специальности 400501-04 (бюджет)
            </h3>
          </Col>
        </Row>
        <Row>
