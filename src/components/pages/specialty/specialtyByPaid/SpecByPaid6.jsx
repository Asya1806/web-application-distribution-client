...
import { getSortedEntrantsBySpecPaid_6 } from "../../../../redux/api/entrant";
...
function SpecByPaid6(props) {
  ...
  React.useEffect(() => {
    const fetchEntrants = async () => {
      return await dispatch(getSortedEntrantsBySpecPaid_6());
    };
        ...
        <Row>
          <Col>
            <h3 style={{ textAlign: "center", marginBottom: "30px" }}>
              Список абитуриентов специальности 530105 (платное)
            </h3>
          </Col>
        </Row>
        <Row>
